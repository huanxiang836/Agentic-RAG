...
![reactagent](https://raw.githubusercontent.com/spring-ai-alibaba/website/main/static/img/agent/agents/reactagent.png)
...
**MessageFilterInterceptor 消息过滤示例**
...
**ContextualToolInterceptor 基于上下文的工具选择示例**
...
**DynamicModelInterceptor 动态模型选择示例**
